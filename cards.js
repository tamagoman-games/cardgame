...
const SPELL_MASTER = [
  ...
  // 【バランス調整】soul1・生け贄0のままだと、初手から生け贄なしで魂+2(差し引き)でき、
  // そのままバーサーカー(2連撃)へ繋げる初動が強すぎたため、生け贄コスト1を追加。
  // 序盤に生け贄となるモンスターがまだ場にいない状態では使えなくなり、
  // 展開してから使う「中盤の魂加速」カードという位置づけに調整した。
  { id: "soulsurge", name: "魂の奔流", icon: "🌀", type: "spell", effect: "soulGain",
    target: "none", soul: 1, sacrifice: 1, abilities: [],
    value: 3,
