...
const CARD_MASTER = [
  ...
  // 新カードで初めて実際に使用する。
  { id: "lamb",     name: "生け贄の子羊", icon: "🐑", atk: 1, hp: 1, sacrifice: 0, soul: 1, abilities: ["供物"] },
  ...
  { id: "reaper",   name: "死神",         icon: "💀", atk: 3, hp: 4, sacrifice: 2, soul: 4, abilities: ["毒","貫通"] },
  { id: "duelist",  name: "双剣の傭兵",   icon: "⚔️", atk: 3, hp: 1, sacrifice: 0, soul: 3, abilities: ["2連撃"] }
];
