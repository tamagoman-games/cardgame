...
const CARD_MASTER = [
  ...
  { id: "golem",    name: "鎧ゴーレム",   icon: "", image: "images/golem.jpg", atk: 2, hp: 3, sacrifice: 0, soul: 3, abilities: ["装甲"] },
  ...
  // 【バランス調整】鎧ゴーレム(atk2/hp3/装甲/soul3)と全く同じ素の数値(atk2/hp3)なのに
  ...
  { id: "wallgiant",  name: "肉壁の巨兵",     icon: "🗿", atk: 0, hp: 6, sacrifice: 1, soul: 4, abilities: ["身代わり"] },
  // ---- 追加カード1種(新能力「断末魔」お披露目用。安価な使い捨て身代わり役) ----
  // 肉壁の巨兵(atk0/hp6/sac1/soul4)より薄く壊れやすい代わりに、死んだ時にカードを1枚引ける
  // ので、攻撃を受け止めてすぐ退場しても損をしにくい「使い捨ての壁」として運用できる。
  { id: "decoydoll",  name: "囮人形",         icon: "🪆", atk: 0, hp: 2, sacrifice: 0, soul: 2, abilities: ["身代わり","断末魔"] }
];
...
const SPELL_MASTER = [
  ...
  // soul1に変更(それでも差し引き+2の純増があり、魂加速カードとして十分強い)。
  { id: "soulsurge", name: "魂の奔流", icon: "🌀", type: "spell", effect: "soulGain",
    target: "none", soul: 1, sacrifice: 0, abilities: [],
    value: 3,
    desc: "使った瞬間、自分の魂を+3する(差し引き+2)" }
];
...
const ABILITY_INFO = {
  ...
  "不死":   "戦闘でHPが0になった時、または生け贄に選ばれた時、そのカードにつき1回だけHP満タンで復活する(生け贄に選ばれた場合は場に残り、生け贄コストの支払いにはならない)。",
...
const AI_DECK_COUNTS = {
  ...
  souleater: 1, seer: 1, harpy: 1, wallgiant: 1, decoydoll: 2,
  elixir: 1, flashstep: 1, fireball: 1, soulsurge: 1
};
