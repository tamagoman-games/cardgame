...
function render(){
  ...
  $('btn-draw').disabled = state.phase!=='draw' || state.locked || hostOffTurn;
  $('btn-scavenge').disabled = state.phase!=='draw' || state.locked || hostOffTurn;
  $('btn-end').disabled = state.phase!=='main' || state.locked || hostOffTurn;
